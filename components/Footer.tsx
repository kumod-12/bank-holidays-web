/**
 * Footer Component
 * Displays footer links, social media, and copyright
 * Content is managed from Payload CMS
 */
...
export function Footer({ footer }: FooterProps) {
  // Return default footer if data not available
  if (!footer || !footer.sections || footer.sections.length === 0) {
    return (
      <footer className="bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            <p className="text-gray-400 text-sm" suppressHydrationWarning>
              © 2026 My Holiday Calendar. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-t border-gray-800 pt-8">
          <p className="text-gray-400 text-sm text-center">{footer.copyright}</p>
        </div>
      </div>
    </footer>
  );
